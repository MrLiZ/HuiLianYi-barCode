...
- (void)startScan:(CDVInvokedUrlCommand *)command{
    ...
    [self.commandDelegate runInBackground:^{
        ...
        //  @{@"title":@"扫码上方",@"tipScan":@"扫码下方",@"tipInput":@"输入单号",@"tipLoading":@"正在处理中",@"tipNetworkError":@"网络错误提示",@"tipOffline":@"没有打开web提示",@"openButton":@"我已打开",@"footerFirst":@"底部提示第一行",@"footerSecond":@"底部提示第二行"};
